...
/**
 * IRequestProcessor3 Interface
 *
 * <p>uuid({3B635BF7-6DA9-46C8-A1F6-F0C93F10D52F})</p>
 */
@ComInterface(iid="{3B635BF7-6DA9-46C8-A1F6-F0C93F10D52F}")
public interface IRequestProcessor3 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
