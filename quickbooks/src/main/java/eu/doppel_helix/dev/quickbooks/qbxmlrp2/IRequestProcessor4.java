...
/**
 * IRequestProcessor4 Interface
 *
 * <p>uuid({8DB91B17-D5A2-41DB-80A7-CC6F1E449A05})</p>
 */
@ComInterface(iid="{8DB91B17-D5A2-41DB-80A7-CC6F1E449A05}")
public interface IRequestProcessor4 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
